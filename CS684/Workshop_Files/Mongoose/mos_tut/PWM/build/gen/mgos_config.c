...
const struct mgos_conf_entry mgos_config_schema_[147] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 146},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "color_synth", .offset = offsetof(struct mgos_config, color_synth), .num_desc = 4},
  {.type = CONF_TYPE_INT, .key = "freq", .offset = offsetof(struct mgos_config, color_synth.freq)},
  {.type = CONF_TYPE_DOUBLE, .key = "r_int", .offset = offsetof(struct mgos_config, color_synth.r_int)},
  {.type = CONF_TYPE_DOUBLE, .key = "g_int", .offset = offsetof(struct mgos_config, color_synth.g_int)},
  {.type = CONF_TYPE_DOUBLE, .key = "b_int", .offset = offsetof(struct mgos_config, color_synth.b_int)},
};
...
const struct mgos_config mgos_config_defaults = {
  ...
  .color_synth.freq = 5000,
  .color_synth.r_int = 0.5,
  .color_synth.g_int = 0.5,
  .color_synth.b_int = 0.5,
};
...
const struct mgos_config_color_synth * mgos_config_get_color_synth(struct mgos_config *cfg) {
  return &cfg->color_synth;
}
const struct mgos_conf_entry *mgos_config_schema_color_synth(void) {
  return mgos_conf_find_schema_entry("color_synth", mgos_config_schema());
}
...
bool mgos_config_copy_color_synth(const struct mgos_config_color_synth *src, struct mgos_config_color_synth *dst) {
  return mgos_conf_copy(mgos_config_schema_color_synth(), src, dst);
}
void mgos_config_free_color_synth(struct mgos_config_color_synth *cfg) {
  return mgos_conf_free(mgos_config_schema_color_synth(), cfg);
}
