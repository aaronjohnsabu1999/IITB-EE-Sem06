 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.17.0/apps/PWM/esp32/build_contexts/build_ctx_117218316/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.17.0/apps/PWM/esp32/build_contexts/build_ctx_117218316/build/gen/mos_conf_schema.yml
 */
...
struct mgos_config_color_synth {
  int freq;
  double r_int;
  double g_int;
  double b_int;
...
struct mgos_config {
  ...
  struct mgos_config_color_synth color_synth;
};
...
/* color_synth */
#define MGOS_CONFIG_HAVE_COLOR_SYNTH
#define MGOS_SYS_CONFIG_HAVE_COLOR_SYNTH
const struct mgos_config_color_synth * mgos_config_get_color_synth(struct mgos_config *cfg);
static inline const struct mgos_config_color_synth * mgos_sys_config_get_color_synth(void) { return mgos_config_get_color_synth(&mgos_sys_config); }
const struct mgos_conf_entry *mgos_config_schema_color_synth(void);
bool mgos_config_parse_color_synth(struct mg_str json, struct mgos_config_color_synth *cfg);
bool mgos_config_copy_color_synth(const struct mgos_config_color_synth *src, struct mgos_config_color_synth *dst);
void mgos_config_free_color_synth(struct mgos_config_color_synth *cfg);

/* color_synth.freq */
#define MGOS_CONFIG_HAVE_COLOR_SYNTH_FREQ
#define MGOS_SYS_CONFIG_HAVE_COLOR_SYNTH_FREQ
int mgos_config_get_color_synth_freq(struct mgos_config *cfg);
static inline int mgos_sys_config_get_color_synth_freq(void) { return mgos_config_get_color_synth_freq(&mgos_sys_config); }
void mgos_config_set_color_synth_freq(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_color_synth_freq(int v) { mgos_config_set_color_synth_freq(&mgos_sys_config, v); }

/* color_synth.r_int */
#define MGOS_CONFIG_HAVE_COLOR_SYNTH_R_INT
#define MGOS_SYS_CONFIG_HAVE_COLOR_SYNTH_R_INT
double mgos_config_get_color_synth_r_int(struct mgos_config *cfg);
static inline double mgos_sys_config_get_color_synth_r_int(void) { return mgos_config_get_color_synth_r_int(&mgos_sys_config); }
void mgos_config_set_color_synth_r_int(struct mgos_config *cfg, double v);
static inline void mgos_sys_config_set_color_synth_r_int(double v) { mgos_config_set_color_synth_r_int(&mgos_sys_config, v); }

/* color_synth.g_int */
#define MGOS_CONFIG_HAVE_COLOR_SYNTH_G_INT
#define MGOS_SYS_CONFIG_HAVE_COLOR_SYNTH_G_INT
double mgos_config_get_color_synth_g_int(struct mgos_config *cfg);
static inline double mgos_sys_config_get_color_synth_g_int(void) { return mgos_config_get_color_synth_g_int(&mgos_sys_config); }
void mgos_config_set_color_synth_g_int(struct mgos_config *cfg, double v);
static inline void mgos_sys_config_set_color_synth_g_int(double v) { mgos_config_set_color_synth_g_int(&mgos_sys_config, v); }

/* color_synth.b_int */
#define MGOS_CONFIG_HAVE_COLOR_SYNTH_B_INT
#define MGOS_SYS_CONFIG_HAVE_COLOR_SYNTH_B_INT
double mgos_config_get_color_synth_b_int(struct mgos_config *cfg);
static inline double mgos_sys_config_get_color_synth_b_int(void) { return mgos_config_get_color_synth_b_int(&mgos_sys_config); }
void mgos_config_set_color_synth_b_int(struct mgos_config *cfg, double v);
static inline void mgos_sys_config_set_color_synth_b_int(double v) { mgos_config_set_color_synth_b_int(&mgos_sys_config, v); }
