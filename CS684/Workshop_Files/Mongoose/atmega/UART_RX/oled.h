...
#define FONT            ssd1306oled_font// set font here, refer font-name at font.h/font.c
    ...
    // using 7-bit-adress for oled-library
...
#define DISPLAY_HEIGHT        64
    ...
    void oled_command(uint8_t cmd[], uint8_t size);    // transmit command to display
    void oled_data(uint8_t data[], uint16_t size);    // transmit data to display
    ...
    // y means line (page, refer oled manual)
